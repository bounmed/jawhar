...
class Prefix:
    """
    This class provides implementations for Arabic prefixes.
    ...
    def __str__(self) -> str:
        return f"Prefix(unvoweledform={self.unvoweledform}, voweledform={self.voweledform}, classe={self.classe})"
